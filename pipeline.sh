...
python survplots.py --input_csv 2024_transformed.csv --plot kaplan_meier --max_survival_length 2000 --columns gene_CASP8,gene_LRP1B,gene_TP53,gene_MTAP,gene_PIK3CA,gene_ARID1A,response_0,sex,age_level,anatomic_stage,pdl1_category,cancer_type --output_pdf $output_dir/figure_4_overall_survival_kaplan_meier.pdf --min_size_of_group 0.03
python survplots.py --input_csv tcga_data2.csv --plot kaplan_meier --max_survival_length 2000 --columns gene_MTAP,gene_CASP8,gene_LRP1B,gene_TP53,gene_MTAP,gene_PIK3CA,gene_ARID1A,sex,anatomic_stage,cancer_type --output_pdf $output_dir/figure_4_overall_survival_kaplan_meier_tcga.pdf --min_size_of_group 0.03
