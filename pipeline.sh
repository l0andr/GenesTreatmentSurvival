...
python survplots.py --input_csv tdf.csv --survival_time_col disease_free_time --plot kruskal_wallis_test --max_survival_length 2000 --columns tnum,response,treatment_type --output_pdf Figure_7_kruskal_wallis_test.pdf --min_size_of_group 0.03 --custom_legend km_legend.json --tiff --filter_nan_columns treatment_type,respons
