...
python swimmer_plot.py -input_csv tdf.csv -output_file figure_1_swimmer_plot.png -treatment_id tnum -treatment_column treatment_type -response_column response
...
python cox_analysis.py -input_csv tcga_data2.csv --genes LRP1B,MTAP,CCND1,FGF4,TP53,PIK3CA,ARID1A --factors age,cancer_type,sex --penalizer 0.01 --l1ratio 0.01 --univar sex,age,cancer_type --show
