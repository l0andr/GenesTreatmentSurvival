...
python adaptree.py -input_csv tdf.csv -ycolumn binary_response --xcolumns gene_TP53,gene_ASXL1,gene_AXIN1,gene_MYL1,gene_SOX2,gene_FGF4,sex,cancer_type,gene_ARID2,gene_CDKN2A,gene_PIK3CA,treatment_group,anatomic_stage,gene_MTAP,gene_CCND1,gene_TERT --verbose 2 --sort_columns patient_id,tnum --unique_record patient_id,treatment_type,binary_response --output_model response_dt_6_max_mean_purity.model --criteria entropy --model response_dt_6_max_mean_purity.model --steps_of_optimization 150 --class_names Bad,Good --filter_nan_columns treatment_type,response --min_samples_leaf 8 --max_depth 6 --max_leaf_nodes 16 --plot_type dtreeviz --random_seed 2 --custom_legend km_legend.json --tiff $output_dir/figure_9_disease_free_survival_decision_tree.tiff
python survplots.py --input_csv tdf_initial.csv --survival_time_col disease_free_time --plot kaplan_meier --max_survival_length 2000 --columns tnum,treatment_group,response,sex,cancer_type,alcohol_history,drugs,anatomic_stage,gene_FGF4,gene_CDKN2A,gene_MYL1,gene_TP53,gene_PIK3CA,gene_ARID2,gene_MTAP,gene_CASP8,gene_LRP1B,gene_EGFR,gene_TERT --output_pdf $output_dir/figure_10_disease_free_time_kaplan_meier_initial_treatment_all.pdf --min_size_of_group 0.01 --custom_legend km_legend.json --filter_nan_columns treatment_type,response --tiff
python survplots.py --input_csv tdf_recurrence.csv --survival_time_col disease_free_time --plot kaplan_meier --max_survival_length 2000 --columns tnum,treatment_group,response,sex,cancer_type,alcohol_history,drugs,anatomic_stage,gene_FGF4,gene_CDKN2A,gene_MYL1,gene_TP53,gene_PIK3CA,gene_ARID2,gene_MTAP,gene_CASP8,gene_LRP1B,gene_EGFR,gene_TERT --output_pdf $output_dir/figure_11_disease_free_time_kaplan_meier_recurrence_treatment_all.pdf --min_size_of_group 0.01 --custom_legend km_legend.json --filter_nan_columns treatment_type,response --tiff
