...
python swimmer_plot.py -input_csv tdf.csv -output_file $output_dir/figure_1_swimmer_plot.pdf -treatment_id tnum -treatment_column treatment_type -response_column response $show -survival_right_labels_column overall_survival -on_therapy_column current_treatment
python oncoplot.py -input_mutation 2024_transformed.csv -output_file $output_dir/figure_2_UMB_oncoplot.pdf -list_of_factors sex,smoking,p16,cancer_type,prior_cancer $show --number_of_genes 30 --verbose 3 --title "Oncoplot UMB cohort"
...
python cox_analysis.py -input_csv tcga_data2.csv --genes LRP1B,MTAP,CASP8,PIK3CA,ARID1A --factors age,cancer_type,sex --penalizer 0.02 --l1ratio 0.01 --model_report $figure_3_overall_survival_tcga.pdf --title "TCGA. overall survival time" $show
python survplots.py --input_csv 2024_transformed.csv --plot kaplan_meier --max_survival_length 2000 --columns gene_CASP8,gene_LRP1B,gene_TP53,gene_MTAP,gene_PIK3CA,gene_ARID1A,response_0,sex,age_level,anatomic_stage,pdl1_category,cancer_type --output_pdf $output_dir/figure_4_overall_survival_kaplan_meier.pdf --min_size_of_group 0.03 --custom_legend km_legend.json
python survplots.py --input_csv tcga_data2.csv --plot kaplan_meier --max_survival_length 2000 --columns gene_MTAP,gene_CASP8,gene_LRP1B,gene_TP53,gene_MTAP,gene_PIK3CA,gene_ARID1A,sex,anatomic_stage,cancer_type --output_pdf $output_dir/figure_4_overall_survival_kaplan_meier_tcga.pdf --min_size_of_group 0.03 --custom_legend km_legend.json
python cox_analysis.py -input_csv tdf.csv --survival_time_col disease_free_time --status_col status --genes TP53,CDKN2A,TERT,FAT1,KMT2D,PIK3CA,FGF3,NOTCH1,FGF4,ZNF750,ARID1A,CCND1,LRP1B,CDKN2B,EGFR,KMT2C,CASP8,NFE2L2,CYLD,FBXW7,FLCN,MTAP,MYL1,NOTCH3,SMAD4,SOX2,B2M,ARID2,ASXL1,CIC --factors "" --penalizer 0.01 --l1ratio 0.01 $show --univar "" --filter_nan --filter_nan_columns treatment_type,response --model_report $output_dir/figure_5_disease_free_survival_cox_univariant_genes.pdf --title "disease free survival time "
python cox_analysis.py -input_csv tdf.csv --survival_time_col disease_free_time --status_col status --genes "" --factors sex,age,p16,smoking,alcohol_history,race,cancer_type,drugs,treatment_type,anatomic_stage,response,tnum --penalizer 0.01 --l1ratio 0.01 $show --univar "" --filter_nan --filter_nan_columns treatment_type,response --model_report $output_dir/figure_5_disease_free_survival_cox_univariant_factors.pdf --title "disease free survival time "
python cox_analysis.py -input_csv tdf.csv --survival_time_col disease_free_time --status_col status --genes TP53,CDKN2A,TERT,FAT1,KMT2D,PIK3CA,FGF3,NOTCH1,FGF4,ZNF750,ARID1A,CCND1,LRP1B,CDKN2B,EGFR,KMT2C,CASP8,NFE2L2,CYLD,FBXW7,FLCN,MTAP,MYL1,NOTCH3,SMAD4,SOX2,B2M,ARID2,ASXL1,CIC --factors sex,age,p16,smoking,alcohol_history,race,cancer_type,drugs,treatment_type,anatomic_stage,response,tnum --penalizer 0.01 --l1ratio 0.01 $show --univar "sex,age,tnum,response,cancer_type" --model_report $output_dir/figure_5_disease_free_survival_cox_fix_univariant.pdf --title "disease free survival time " --filter_nan --filter_nan_columns treatment_type,response
python survplots.py --input_csv tdf.csv --survival_time_col disease_free_time --plot kaplan_meier --max_survival_length 2000 --columns tnum,response,sex,cancer_type,alcohol_history,drugs,anatomic_stage,gene_FGF4,gene_CDKN2A,gene_MYL1,gene_ARID2 --output_pdf $output_dir/figure_6_disease_free_time_kaplan_meier.pdf --min_size_of_group 0.03 --custom_legend km_legend.json
python survplots.py --input_csv tdf.csv --status_col binary_response --plot fisher_exact_test --columns gene_* --output_pdf $output_dir/figure_8_all_treatments_fisher_test.pdf --min_size_of_group 0.03 --title "Response-Genes relation. All type of treatments." $show
python survplots.py --input_csv tdf_chemo.csv --status_col binary_response --plot fisher_exact_test --columns gene_* --output_pdf $output_dir/figure_8_chemo_fisher_test.pdf --min_size_of_group 0.03 --title "Response-Genes relation. Chemotherapy." $show
python survplots.py --input_csv tdf_imuno.csv --status_col binary_response --plot fisher_exact_test --columns gene_* --output_pdf $output_dir/figure_8_imuno_fisher_test.pdf --min_size_of_group 0.03 --title "Response-Genes relation. Imunotherapy." $show
python survplots.py --input_csv tdf_radio.csv --status_col binary_response --plot fisher_exact_test --columns gene_* --output_pdf $output_dir/figure_8_radio_fisher_test.pdf --min_size_of_group 0.03 --title "Response-Genes relation. Surgical\Radiotherapy." $show
