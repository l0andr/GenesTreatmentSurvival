...
python survplots.py --input_csv tdf.csv --status_col binary_response --plot fisher_exact_test --columns gene* --output_pdf $output_dir/figure_8_all_treatments_fisher_test.pdf --min_size_of_group 0.03 --title "Response-Genes relation. All type of treatments." $show
python survplots.py --input_csv tdf_chemo.csv --status_col binary_response --plot fisher_exact_test --columns gene* --output_pdf $output_dir/figure_8_chemo_fisher_test.pdf --min_size_of_group 0.03 --title "Response-Genes relation. Chemotherapy." $show
python survplots.py --input_csv tdf_imuno.csv --status_col binary_response --plot fisher_exact_test --columns gene* --output_pdf $output_dir/figure_8_imuno_fisher_test.pdf --min_size_of_group 0.03 --title "Response-Genes relation. Imunotherapy." $show
python survplots.py --input_csv tdf_radio.csv --status_col binary_response --plot fisher_exact_test --columns gene* --output_pdf $output_dir/figure_8_radio_fisher_test.pdf --min_size_of_group 0.03 --title "Response-Genes relation. Surgical\Radiotherapy." $show
