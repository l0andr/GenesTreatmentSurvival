...
python survplots.py --input_csv tdf.csv --survival_time_col disease_free_time --plot kruskal_wallis_test --max_survival_length 2000 --columns tnum,response,treatment_type --output_pdf $output_dir/figure_7_kruskal_wallis_test.pdf --min_size_of_group 0.03 --custom_legend km_legend.json --tiff --filter_nan_columns treatment_type,respons
python survplots.py --input_csv tdf_recurrence.csv --survival_time_col disease_free_time --plot kaplan_meier --max_survival_length 2000 --columns sex,cancer_type,gene_FGF4 --output_pdf $output_dir/figure_10_disease_free_time_reccurence_kaplan_meier_selected.pdf --min_size_of_group 0.01 --custom_legend km_legend.json --filter_nan_columns treatment_type,response --tiff
python survplots.py --input_csv tdf_recurrence.csv --survival_time_col disease_free_time --plot kaplan_meier --max_survival_length 2000 --columns sex,cancer_type,gene_FGF4 --output_pdf $output_dir/figure_10_disease_free_time_reccurence_kaplan_meier_selected.pdf --min_size_of_group 0.01 --custom_legend km_legend.json --filter_nan_columns treatment_type,response --tiff
