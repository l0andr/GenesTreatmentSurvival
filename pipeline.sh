...
python swimmer_plot.py -input_csv tdf.csv -output_file figure_1_swimmer_plot.pdf -treatment_id tnum -treatment_column treatment_type -response_column response --show
python oncoplot.py -input_mutation 2024_transformed.csv -output_file figure_2_UMB_oncoplot.pdf -list_of_factors sex,smoking,p16,cancer_type,prior_cancer --show --number_of_genes 30 --verbose 3 --title "Oncoplot UMB cohort"
python oncoplot.py -input_mutation tcga_data2.csv -output_file figure_2_TCGA_oncoplot.pdf -list_of_factors sex,smoking,cancer_type --show --number_of_genes 30 -list_of_genes TP53,CDKN2A,TERT,FAT1,KMT2D,PIK3CA,FGF3,NOTCH1,FGF4,ZNF750,ARID1A,CCND1,LRP1B,CDKN2B,EGFR,KMT2C,CASP8,NFE2L2,CYLD,FBXW7,FLCN,MTAP,MYL1,NOTCH3,SMAD4,SOX2,B2M,ARID2,ASXL1,CIC --verbose 1 --nosortgenes --title "Oncoplot TCGA cohort"
python cox_analysis.py -input_csv 2024_transformed.csv --genes "" --factors sex,age,p16,smoking,race,cancer_type,prior_cancer,drugs,treatment_type0,total_mutations,anatomic_stage,msi_status,tmb_level,lvi,pni,smoking_packs,pdl1_category,response_0,alcohol_history --penalizer 0.01 --l1ratio 0.01 --univar "" --model_report figure_3_overall_survival_cox_univariant_factors.pdf
python cox_analysis.py -input_csv 2024_transformed.csv --genes TP53,CDKN2A,TERT,FAT1,KMT2D,PIK3CA,FGF3,NOTCH1,FGF4,ZNF750,ARID1A,CCND1,LRP1B,CDKN2B,EGFR,KMT2C,CASP8,NFE2L2,CYLD,FBXW7,FLCN,MTAP,MYL1,NOTCH3,SMAD4,SOX2,ARID2,ASXL1,B2M,CIC --factors "" --penalizer 0.01 --l1ratio 0.01 --univar "" --show
python cox_analysis.py -input_csv 2024_transformed.csv --genes TP53,CDKN2A,TERT,FAT1,KMT2D,PIK3CA,FGF3,NOTCH1,FGF4,ZNF750,ARID1A,CCND1,LRP1B,CDKN2B,EGFR,KMT2C,CASP8,NFE2L2,CYLD,FBXW7,FLCN,MTAP,MYL1,NOTCH3,SMAD4,SOX2,ARID2,ASXL1,B2M,CIC --factors sex,age,p16,smoking,alcohol_history,race,cancer_type,prior_cancer,drugs,treatment_type0,total_mutations,anatomic_stage,msi_status,tmb_level,lvi,pni,smoking_packs,pdl1_category,response_0 --penalizer 0.01 --l1ratio 0.01 --univar sex,age,response_0,anatomic_stage --show
python cox_analysis.py -input_csv tcga_data2.csv --genes LRP1B,MTAP,CASP8,PIK3CA,ARID1A --factors age,cancer_type,sex --penalizer 0.01 --l1ratio 0.01 --univar sex,age,cancer_type --show
...
python survplots.py --input_csv tcga_data2.csv --plot kaplan_meier --max_survival_length 2000 --columns gene_MTAP,gene_CASP8,gene_LRP1B,gene_TP53,gene_MTAP,gene_PIK3CA,gene_ARID1A,sex,anatomic_stage,cancer_type --output_pdf overall_survival_kaplan_meier_tcga.pdf --min_size_of_group 0.03
python cox_analysis.py -input_csv tdf.csv --survival_time_col disease_free_time --status_col status --genes TP53,CDKN2A,TERT,FAT1,KMT2D,PIK3CA,FGF3,NOTCH1,FGF4,ZNF750,ARID1A,CCND1,LRP1B,CDKN2B,EGFR,KMT2C,CASP8,NFE2L2,CYLD,FBXW7,FLCN,MTAP,MYL1,NOTCH3,SMAD4,SOX2,B2M,ARID2,ASXL1,CIC --factors "" --penalizer 0.01 --l1ratio 0.01 --show --univar "" --filter_nan --filter_nan_columns treatment_type,response
python cox_analysis.py -input_csv tdf.csv --survival_time_col disease_free_time --status_col status --genes "" --factors sex,age,p16,smoking,alcohol,race,cancer_type,drugs,treatment_type,anatomic_stage,response,tnum --penalizer 0.01 --l1ratio 0.01 --show --univar "" --filter_nan --filter_nan_columns treatment_type,response
